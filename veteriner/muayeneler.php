...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-center mb-4 gap-3">
    <form method="GET" action="muayeneler.php" class="w-100" style="max-width: 600px;">
...
<div class="row row-cols-1 row-cols-lg-2 g-4">
    <?php if (count($examinations) > 0): ?>
        ...
        ?>
            <div class="col">
                <div class="card h-100 border-0 shadow-sm rounded-4 p-4" style="border: 1px solid #f0f0f0 !important;">
                    
                    <!-- Kart Başlığı -->
                    <div class="d-flex justify-content-between align-items-start mb-4">
                        <div class="d-flex align-items-center">
                            <div class="text-danger bg-danger-subtle rounded-circle d-flex align-items-center justify-content-center me-3" style="width: 48px; height: 48px; font-size: 20px;">
                    ...
                    <div class="d-flex text-muted mt-auto" style="font-size: 13px;">
                        ...
                        <a href="guncelle.php?id=<?= $exam['id'] ?>" class="ms-auto text-decoration-none text-primary"><i class="fa-solid fa-pen"></i> Düzenle</a>
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
